...
class FreeCachedContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'MailPoet\\WooCommerce\\TransactionalEmails\\Renderer' => 'getRenderer3Service',
        ...
        $this->privates = [
            ...
            'MailPoet\\Form\\FormFactory' => true,
    ...
    /**
     * Gets the private 'MailPoet\Form\Block\Date' shared autowired service.
     *
     * @return \MailPoet\Form\Block\Date
     */
    protected function getDateService()
    {
        return $this->services['MailPoet\\Form\\Block\\Date'] = new \MailPoet\Form\Block\Date(${($_ = isset($this->services['MailPoet\\Form\\Block\\BlockRendererHelper']) ? $this->services['MailPoet\\Form\\Block\\BlockRendererHelper'] : $this->getBlockRendererHelperService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['MailPoet\\Form\\Block\\Submit'] = new \MailPoet\Form\Block\Submit(${($_ = isset($this->services['MailPoet\\Form\\Block\\BlockRendererHelper']) ? $this->services['MailPoet\\Form\\Block\\BlockRendererHelper'] : $this->getBlockRendererHelperService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['MailPoet\\Form\\Block\\Text'] = new \MailPoet\Form\Block\Text(${($_ = isset($this->services['MailPoet\\Form\\Block\\BlockRendererHelper']) ? $this->services['MailPoet\\Form\\Block\\BlockRendererHelper'] : $this->getBlockRendererHelperService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['MailPoet\\Form\\Block\\Textarea'] = new \MailPoet\Form\Block\Textarea(${($_ = isset($this->services['MailPoet\\Form\\Block\\BlockRendererHelper']) ? $this->services['MailPoet\\Form\\Block\\BlockRendererHelper'] : $this->getBlockRendererHelperService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'MailPoet\Form\FormFactory' shared autowired service.
     *
     * @return \MailPoet\Form\FormFactory
     */
    protected function getFormFactoryService()
    {
        return $this->services['MailPoet\\Form\\FormFactory'] = new \MailPoet\Form\FormFactory();
    }
